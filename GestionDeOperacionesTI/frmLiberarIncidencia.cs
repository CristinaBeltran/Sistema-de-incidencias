...
namespace GestionDeOperacionesTI
{
    public partial class frmLiberarIncidencia : Form
    {
        ...
        private void frmLiberarIncidencia_Load(object sender, EventArgs e)
        {
            ...
            string strComandoC2 = "SELECT I.ID,I.Descripcion,T.Descripcion,P.Descripcion, I.FechaInicio, I.Tiempo_Respuesta FROM INCIDENCIA I INNER JOIN PRIORIDAD P ON I.ID_Prioridad=P.ID INNER JOIN TIPO_INCIDENCIA T ON I.ID_Tipo=T.ID WHERE I.ID_Stat=4 AND I.ID_Tecnico=" + TecID;
        ...
        private void btnAct_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("LIBERACION DE LA INCIDENCIA "+InID+" EXITOSA", "AVISO", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
}
