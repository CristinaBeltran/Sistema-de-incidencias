...
namespace GestionDeOperacionesTI
{
    public class ManejaCI
    {
        public bool AddCI(string Nombre, string Descripcion, string NumSerie, string FechaAdqui, int LocID, int EncaID, int ProvID)
        {
            ...
            string strComando = "INSERT INTO CI(Nombre,Descripcion,NumSerie,FechaAdquisicion,ID_Localizacion,ID_Encargado,ID_Proveedor)";
            strComando += " VALUES(@Nombre,@Descripcion,@NumSerie,@FechaAdqui,@LocID,@EncaID,@ProvID)";
        ...
        public bool AddUpCI(string Nombre, string Descripcion, string NumSerie, string FechaAdqui, int LocID, int EncaID, int ProvID)
        {
            ...
            string strComando = "INSERT INTO CAMBIOS_CI(IDCI,Nombre,Descripcion,NumSerie,FechaAdquisicion,ID_Localizacion,ID_Encargado,ID_Proveedor)";
            strComando += " VALUES(@IDCI,@Nombre,@Descripcion,@NumSerie,@FechaAdqui,@LocID,@EncaID,@ProvID)";
        ...
        public bool UpdateDesc(int ID, string Desc)
        {
            ...
            Update.Parameters.AddWithValue("@Descripcion", Desc.Trim());
