...
namespace GestionDeOperacionesTI
{
    public partial class frmUpdateEmpleado : Form
    {
        ...
        public frmUpdateEmpleado(ManejaEmpleado AdmEmp)
        {
            InitializeComponent();
            this.AdmEmp = AdmEmp;
        }
        private void frmUpdateEmpleado_Load(object sender, EventArgs e)
        {
            ...
            string strComandoC = "SELECT Nombre FROM EMPLEADO";
        ...
        private void cmbEncargado_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string strComandoC = "SELECT Nombre,Celular,Email,Direccion FROM EMPLEADO WHERE ID =" + ID;
