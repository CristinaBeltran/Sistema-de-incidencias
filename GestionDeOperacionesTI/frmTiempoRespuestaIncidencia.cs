    ...
    public partial class frmTiempoRespuestaIncidencia : Form
    {
            ...
            for (int i = 0; i < lvIndicencias.Items.Count; i++)
            {
                if (lvIndicencias.SelectedItems.Contains(lvIndicencias.Items[i]))
                {
                    ...
                    if (Tipo == 1)
                    {
                        ...
                        string strComandoC2 = "SELECT ID_CI FROM INCIDENCIA I WHERE I.ID=" + InID;
                    ...
                    else
                    {
                        ...
                        string strComandoC3 = "SELECT Ubicacion FROM INCIDENCIA I WHERE I.ID=" + InID;
        ...
        private void frmTiempoRespuestaIncidencia_Load(object sender, EventArgs e)
        {
            SqlConnection Connection2 = UsoBD.ConectaBD(Utileria.GetConnectionString());
                ...
                string strComandoC2 = "SELECT I.ID,I.Descripcion,T.Descripcion,P.Descripcion, I.FechaInicio, I.Tiempo_Respuesta FROM INCIDENCIA I INNER JOIN PRIORIDAD P ON I.ID_Prioridad=P.ID INNER JOIN TIPO_INCIDENCIA T ON I.ID_Tipo=T.ID WHERE I.ID_Tecnico=" + TecID;
                Lector2 = UsoBD.Consulta(strComandoC2, Connection2);
