...
namespace GestionDeOperacionesTI
{
    public partial class frmMenuAdministrador : Form
    {
        ...
        {
            AbrirForm(new frmAltaEmpleado(AdmEmp));
        }
