...
namespace GestionDeOperacionesTI
{
    public partial class Login : Form
    {
        ...
        private void btnIngresar_Click(object sender, EventArgs e)
        {
            ...
            if (ID == 0)
            {
                MessageBox.Show("EL EMAIL INGRESADO NO COINCIDE CON NINGUNA CUENTA", "ERROR", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            switch (Rol)
            {
                case 1:
                    ...
                    break;
                case 2:
                    frmMenuJefe frmMenuJefeTaller = new frmMenuJefe(AdmEmp,ID);
                    frmMenuJefeTaller.ShowDialog();
                    break;
                case 3:
                    frmMenuTecnico frmMenuTec = new frmMenuTecnico(AdmEmp,ID);
                    frmMenuTec.ShowDialog();
                    break;
                case 4:
                    frmMenuDocente frmMenuDoc = new frmMenuDocente(AdmEmp,ID);
