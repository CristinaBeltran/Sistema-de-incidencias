...
AS
	...
	SELECT @IDCI=ID,@Name=Nombre,@Desc=Descripcion,@NumSerie=NumSerie,@FechaAd=FechaAdquisicion,@LocID=ID_Localizacion,@EncID=ID_Encargado,@ProID=ID_Proveedor FROM inserted
	
	BEGIN
		INSERT INTO CAMBIOS_CI(IDCI,Nombre,Descripcion,NumSerie,FechaAdquisicion,ID_Localizacion,ID_Encargado,ID_Proveedor) 
		VALUES(@IDCI,@Name,@Desc,@NumSerie,@FechaAd,@LocID,@EncID,@ProID) 
...
INSERT INTO  EMPLEADO(Nombre,Email,Celular,Direccion,ID_Rol,Contraseña)
VALUES('MARCO ANTONIO RODRIGUEZ AVILES','Marco@itculiacan.edu.mx','6671234567','Villa Alegria',1,'12345')
INSERT INTO  EMPLEADO(Nombre,Email,Celular,Direccion,ID_Rol,Contraseña)
VALUES('JORGE GUILLERMO MOYA PALAZUELOS','Jorge@itculiacan.edu.mx','6672567032','Los Cascaveles',2,'12345')
INSERT INTO  EMPLEADO(Nombre,Email,Celular,Direccion,ID_Rol,Contraseña)
VALUES('NOEL GARCIA INZUNZA','Noel@itculiacan.edu.mx','6670987654','Rancho Contento',3,'12345')
INSERT INTO  EMPLEADO(Nombre,Email,Celular,Direccion,ID_Rol,Contraseña)
VALUES('ELIZABETH BARRAZA GARCIA','Elizabeth@itculiacan.edu.mx','6610293845','Los Pinos',4,'12345')
INSERT INTO  EMPLEADO(Nombre,Email,Celular,Direccion,ID_Rol,Contraseña)
VALUES('MARIA DEL ROSARIO GONZALEZ ALVAREZ','Rosario@itculiacan.edu.mx','6610200826','Las lomas',4,'12345')
...
INSERT INTO CAMBIOS_CI(IDCI,Nombre,Descripcion,NumSerie,FechaAdquisicion,ID_Localizacion,ID_Encargado,ID_Proveedor)
VALUES(1,'COMPUTADORA','COMPUTADORA HP','12345678','2020/01/16',1,2,1)
