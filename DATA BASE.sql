...
SELECT ID FROM CI WHERE NumSerie LIKE
...
INSERT INTO CI(Nombre,Descripcion,NumSerie,FechaAdquisicion,ID_Localizacion,ID_Encargado,ID_Proveedor)
VALUES('COMPUTADORA','COMPUTADORA HP','12345678','2020/01/16',1,2,1)
SELECT * FROM CI

SELECT * FROM DEPARTAMENTO
SELECT ID FROM LOCALIZACION WHERE Ubicacion LIKE 'A'
SELECT ID FROM EDIFICIO WHERE Nombre LIKE 'A'
...
SELECT ID FROM ROL WHERE Nombre LIKE 'ADMINISTRADOR'

--DELETE FROM LOCALIZACION WHERE ID = 3 
--DELETE FROM EMPLEADO WHERE Nombre LIKE '' AND Email LIKE ''
DELETE FROM DEPARTAMENTO WHERE Nombre LIKE ''

SELECT E.Nombre,Email,Celular,Direccion,R.Nombre FROM EMPLEADO E INNER JOIN ROL R ON E.ID_Rol=R.ID 

SELECT D.Nombre,E.Nombre FROM DEPARTAMENTO D INNER JOIN EMPLEADO E ON D.ID_EmpEncar=E.ID ORDER BY D.Nombre
...
SELECT CI.Nombre,CI.Descripcion,CI.NumSerie,CI.FechaAdquisicion,E.Nombre,EM.Nombre,P.Nombre FROM CI 
...
--DELETE FROM CI WHERE NumSerie =

SELECT * FROM LOCALIZACION
SELECT E.Nombre,Email,Celular,Direccion,R.Nombre FROM EMPLEADO E INNER JOIN ROL R ON E.ID_Rol=R.ID ORDER BY E.Nombre

SELECT L.NumPlanta FROM CI INNER JOIN LOCALIZACION L ON CI.ID = L.ID WHERE NumSerie LIKE '12345678' 
SELECT FechaAdquisicion FROM CI WHERE NumSerie LIKE '12345678' 

--UPDATE CI SET Descripcion='xx' WHERE ID=3
--UPDATE CI SET ID_Proveedor=2 WHERE ID=3
UPDATE LOCALIZACION SET Nombre='' WHERE ID=3
SELECT * FROM CI
SELECT * FROM LOCALIZACION
select * from EDIFICIO
SELECT L.ID FROM CI INNER JOIN LOCALIZACION L ON CI.ID_Localizacion = L.ID WHERE NumSerie LIKE '0000000000000000'
SELECT ID FROM EDIFICIO WHERE Nombre LIKE ''
SELECT ID FROM LOCALIZACION WHERE Ubicacion LIKE 'PRIMER CUBICULO ENTRADO, AUN LADO DE LA SECRETARIA'

SELECT ID FROM CI WHERE NumSerie LIKE '123'

SELECT E.Nombre FROM EMPLEADO E INNER JOIN CI ON E.ID = CI.ID_Encargado WHERE CI.NumSerie LIKE '12345678' 
